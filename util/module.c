...
void register_module_init(void (*fn)(void), module_init_type type)
{
    ...
    //将ModuleEntry插入到 type对应的ModuleTypeList
 ...
 *  module_call_init(type == MODULE_INIT_QAPI)
 *  module_call_init(type == MODULE_INIT_OPTS)
 * 
 * main() [vl.c]
 *  bdrv_init_with_whitelist()
 *   bdrv_init()
 *    module_call_init(type == MODULE_INIT_BLOCK)
 */
